...
var referenceName = 'applicationInsightsResource'
...
resource logs 'Microsoft.OperationalInsights/workspaces@2023-09-01' = {
  name: 'law-copilot-native-${suffix}'
  location: location
  tags: tags
  properties: {
    sku: {
...
resource app 'Microsoft.Insights/components@2020-02-02' = {
  name: 'ai-copilot-native-${suffix}'
  location: location
  tags: tags
  kind: 'web'
  properties: {
...
resource metrics 'Microsoft.Monitor/accounts@2025-10-03' = {
  name: 'amw-copilot-native-${suffix}'
  location: location
  tags: tags
  properties: {
...
resource endpoint 'Microsoft.Insights/dataCollectionEndpoints@2024-03-11' = {
  name: 'dce-copilot-native-${suffix}'
  location: location
  tags: tags
  properties: {
    networkAcls: {
...
resource rule 'Microsoft.Insights/dataCollectionRules@2024-03-11' = {
  name: 'dcr-copilot-native-${suffix}'
  location: location
  tags: tags
  properties: {
      ...
      otelMetrics: [
        {
          ...
          enrichWithReference: referenceName
        }
      ]
      otelLogs: [
        {
...
resource publisher 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(rule.id, principalId, 'native-otel-publisher')
  scope: rule
  properties: {
...
resource metricReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(metrics.id, principalId, 'native-otel-reader')
  scope: metrics
  properties: {
    principalId: principalId
    principalType: principalType
...
output nativeState object = {
  ...
  location: location
  application_insights_resource_id: app.id
